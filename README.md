...
- Mac users may need to install `unixodbc` as well as related drivers as shown below:
    ...
    ```
- Check [here](https://docs.microsoft.com/en-us/sql/connect/odbc/linux-mac/install-microsoft-odbc-driver-sql-server-macos?view=sql-server-ver15) to add SQL Server drivers for Mac.# AzureCMS
